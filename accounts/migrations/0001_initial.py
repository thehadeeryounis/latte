...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_accountssignup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'accounts_signup', unique=True, to=orm['auth.User'])),
        ...
        db.send_create_signal('accounts', ['UserenaSignup'])


    def backwards(self, orm):

        # Deleting model 'UserenaSignup'
        db.delete_table('accounts_accountssignup')
    ...
    models = {
        ...
        'accounts.accountssignup': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "u'accounts_signup'", 'unique': 'True', 'to': "orm['auth.User']"})
        }
    }
