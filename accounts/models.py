...
from accounts.utils import get_gravatar, generate_sha1, get_protocol, get_datetime_now
from accounts.managers import UserenaManager, UserenaBaseProfileManager
...
class UserenaBaseProfile(models.Model):
    ...
    privacy = models.CharField(_('privacy'),
                               ...
                               default=accounts_settings.ACCOUNTS_DEFAULT_PRIVACY,
