...
class UserenaManagerTests(TestCase):
    ...
    def test_create_inactive_user(self):
        ...
        self.failUnless(re.match('^[a-f0-9]{40}$', new_user.accounts_signup.activation_key))
    ...
    def test_activation_valid(self):
        ...
        active_user = UserenaSignup.objects.activate_user(user.username,
                                                          user.accounts_signup.activation_key)
        ...
        self.assertEqual(active_user.accounts_signup.activation_key,
    ...
    def test_activation_expired(self):
        ...
        UserenaSignup.objects.activate_user(user.username, user.accounts_signup.activation_key)
        ...
        self.assertEqual(user.accounts_signup.activation_key,
                         active_user.accounts_signup.activation_key)
    ...
    def test_confirmation_valid(self):
        ...
        user.accounts_signup.change_email(new_email)

        # Confirm email
        confirmed_user = UserenaSignup.objects.confirm_email(user.username,
                                                       user.accounts_signup.email_confirmation_key)
        ...
        self.failIf(confirmed_user.accounts_signup.email_unconfirmed)
        self.failIf(confirmed_user.accounts_signup.email_confirmation_key)
