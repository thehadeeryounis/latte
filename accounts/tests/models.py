...
from accounts.models import UserenaSignup, upload_to_mugshot
from accounts import settings as accounts_settings
from accounts.tests.profiles.test import ProfileTestCase
from accounts.tests.profiles.models import Profile
...
class UserenaSignupModelTests(ProfileTestCase):
    ...
    def test_activation_expired_account(self):
        ...
        self.failUnless(user.accounts_signup.activation_key_expired())
    ...
    def test_activation_used_account(self):
        ...
        self.failUnless(activated_user.accounts_signup.activation_key_expired())
    ...
    def test_activation_unexpired_account(self):
        ...
        """
        user = UserenaSignup.objects.create_user(**self.user_info)
        self.failIf(user.accounts_signup.activation_key_expired())
