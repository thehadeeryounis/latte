...
from accounts.tests.profiles.test import ProfileTestCase
...
class UserenaViewsTests(ProfileTestCase):
    ...
    def test_valid_activation(self):
        ...
        self.client.post(reverse('accounts_signup'),
                         data={'username': 'alice',
        ...
        response = self.client.get(reverse('accounts_activate',
                                           kwargs={'username': user.username,
                                                   'activation_key': user.accounts_signup.activation_key}))
    ...
    def test_valid_confirmation(self):
        ...
        user.accounts_signup.change_email('johnie@example.com')

        response = self.client.get(reverse('accounts_email_confirm',
                                           kwargs={'username': user.username,
                                                   'confirmation_key': user.accounts_signup.email_confirmation_key}))
    ...
    def test_signup_view_success(self):
        ...
        # Check for redirect.
        self.assertRedirects(response,
                             reverse('accounts_signup_complete', kwargs={'username': 'alice'}))
    ...
    def test_signin_view(self):
        ...
        response = self.client.get(reverse('accounts_signin'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response,
    ...
    def test_signin_view_remember_me_on(self):
        ...
        """
        response = self.client.post(reverse('accounts_signin'),
    ...
    def test_signout_view(self):
        ...
        response = self.client.get(reverse('accounts_signout'))
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed(response,
